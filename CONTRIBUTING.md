...
free to report it through a [Meta Issue](https://github.com/bluecxt/manga-extensions-repo-french/issues/new?assignees=&labels=Meta+request&template=06_request_meta.yml)
...
Since this fork is focused on a specific set of extensions, a normal clone is recommended:

```bash
git clone git@cle-perso:bluecxt/manga-extensions-repo-french.git
cd manga-extensions-repo-french/
```

## Getting help

- Refer to existing extension code for examples.
...
[`lib-dataimage`](https://github.com/bluecxt/manga-extensions-repo-french/tree/master/lib/dataimage) is a library
...
[`lib-i18n`](https://github.com/bluecxt/manga-extensions-repo-french/tree/master/lib/i18n) is a library for handling
